...
function defineEventHandlersParaElementosHTML () {
    ...
    document.getElementById("acao_ativa").addEventListener("click", onlyOneChecked1);
    document.getElementById("acao_inativa").addEventListener("click", onlyOneChecked2);
}
...
function onlyOneChecked1 () {
    ...
    if (document.getElementById("acao_ativa").checked) {
        if(document.getElementById("acao_inativa").checked) {
            document.getElementById("acao_inativa").checked=false;
        }
    }  
}
...
function onlyOneChecked2 () {
    ...
    if (document.getElementById("acao_inativa").checked) {
        if(document.getElementById("acao_ativa").checked) {
            document.getElementById("acao_ativa").checked=false;
    }
    }  
}