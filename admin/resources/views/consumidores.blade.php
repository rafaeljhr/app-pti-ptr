...
<body>
    ...
    <div class="container content">
        <h1>Consumidores</h1>
        <a class="btn btn-success" href="javascript:void(0)" id="criarConsumidor">Criar Consumidor</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="consumidorForm" name="consumidorForm" class="form-horizontal">
                        ...
                        <button type="submit" class="btn btn-primary" id="saveBtn" value="create" >Criar</button>
                    </form>
                </div>
            </div>
        </dvi>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#criarConsumidor").click(function(){
                $("#consumidor_id").val("");
