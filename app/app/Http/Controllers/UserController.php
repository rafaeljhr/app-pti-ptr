...
class UserController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $request->validate([
            ...
            'numero_contribuinte'=>'required|string',
    ...
    public function update(Request $request) {
        ...
        $request->validate([
            ...
            'telemovel'=>'sometimes|required|string',
            'numero_contribuinte'=>'sometimes|required|string',
            'morada'=>'sometimes|required|string',
            'cidade'=>'sometimes|required|string',
            'codigo_postal_1'=>'sometimes|required|string',
            'codigo_postal_2'=>'sometimes|required|string',
