...
<div class="container mt-5 mb-5">
  ...
  @if(sizeOf(session()->get('produto_cadeia_logistica')) > 0)
    ...
    <div class="row w-100 mt-4 mb-4">
      ...
      <div class="col">
        <h1>EVENTOS LOGÍSTICO DO <b><?php echo session()->get('prod_nome_cadeia_actual')?></b></h1>
      </div>
      <div class="col-auto">
  ...
  @else
    ...
    <div id="noCadeias">
      ...
      <div align="center">
        ...
        <p style="font-size: 20px;">O produto será colocado à venda, quando possuir pelo menos 1 evento logístico.</p>

        <br>

        <a href="{{ URL::to('/eventoLogisticoCreate')}}">
          <button class="btn btn-success" @click="criarUmaCadeiaLogistica()" id="botao_criar">Criar evento logístico</button>
        </a>
