            ...
            @if(session()->get('carrinho_produtos')!=null)
                ...
                <div class="col">
                    ...
                    <div class="card-body text-center">
                        ...
                        <button @click="add2Carrinho('<?php echo session()->get('carrinho_produtos')[$i]['produto_id'] ?>', '<?php echo session()->get('carrinho_produtos')[$i]['produto_nome'] ?>')" id="addCartButton" type="button" class="btn btn-outline-primary" name="{{ route('product-add-carrinho') }}">Adicionar ao carrinho</button> 
                    </div>
